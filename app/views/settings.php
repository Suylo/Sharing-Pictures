<main>
    <div class="mainNav">
        <i class="bi bi-arrow-right"></i> <a href="./home"> Accueil</a> <i class="bi bi-arrow-right"></i> Paramètres
        de
    ...
    <div class="settings">
        ...
        <div class="options">
            ...
            <form method="post">
                <input type="text" name="confirmation" placeholder="<?= self::$userInfos->getUserEmail() ?>"
                       class="input">
